...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='D:/DeepLearning/YOLO/datasetsV4/images/train/')
    parser.add_argument('--source_xml_path', type=str, default='D:/DeepLearning/YOLO/Competition/datasetsV4/labels_xml')
    parser.add_argument('--save_xml_path', type=str, default='datasetsV4/labels_xml_trans')
    parser.add_argument('--save_img_path', type=str, default='datasetsV4/images')
