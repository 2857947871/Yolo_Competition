...
def txt_to_xml(txt_path, img_path, xml_path):
    # 1.字典对标签中的类别进行转换
    dict = {'0': "0 Transverse Cracks",
            '1': "1 Longitudinal Cracks",
            '2': "2 Block Cracks",
            '3': "3 Alligator Cracking",
            '4': "4 Potholes",
            '5': "5 Patching Alligator Cracking",
            '6': "6 Patching Cracks",
            '7': "7 Patching Potholes",
            }
    # 2.找到txt标签文件夹
...
txt_to_xml("D:/DeepLearning/YOLO/datasetsV4/labels/train/", "D:/DeepLearning/YOLO/datasetsV4/images/train/", "D:/DeepLearning/YOLO/Competition/datasetsV4/labels_xml/")